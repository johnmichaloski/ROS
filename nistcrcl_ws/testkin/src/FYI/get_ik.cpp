...
// http://docs.ros.org/diamondback/api/pr2_arm_navigation_tutorials/html/get__ik_8cpp_source.html
#include <ros/ros.h>
...
int main(int argc, char **argv){
	...
	ros::ServiceClient query_client = rh.serviceClient<kinematics_msgs::GetKinematicSolverInfo>("get_ik_solver_info");
	ros::ServiceClient ik_client = rh.serviceClient<kinematics_msgs::GetPositionIK>("get_ik");
