...
// From http://docs.ros.org/diamondback/api/pr2_arm_navigation_tutorials/html/get__fk_8cpp_source.html

int main(int argc, char **argv){
	ros::init (argc, argv, "get_fk");
	ros::NodeHandle rh;

	ros::service::waitForService("get_fk_solver_info");
	ros::service::waitForService("get_fk");

	ros::ServiceClient query_client = 
		rh.serviceClient<kinematics_msgs::GetKinematicSolverInfo>("get_fk_solver_info");
	ros::ServiceClient fk_client = rh.serviceClient<kinematics_msgs::GetPositionFK>("get_fk");
