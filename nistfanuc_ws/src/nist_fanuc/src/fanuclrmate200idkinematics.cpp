...
RCS::Rotation FanucLRMate200idFastKinematics::Convert2Rotation(double *eerot) {
...
void FanucLRMate200idFastKinematics::Convert2RotationMatrix(const RCS::Rotation & quat, double *eerot) {
...
double FanucLRMate200idFastKinematics::harmonize(const std::vector<double> &ik_seed_state, std::vector<double> &solution) const {
    double dist_sqr = 0;
...
size_t FanucLRMate200idFastKinematics::AllPoseToJoints(RCS::Pose & pose, std::vector<std::vector<double>> &joints) {
...
std::vector<double> FanucLRMate200idFastKinematics::FindBoundedSolution(std::vector<std::vector<double>> &solutions,
