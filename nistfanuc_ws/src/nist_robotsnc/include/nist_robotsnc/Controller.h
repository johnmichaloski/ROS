        ...
        public KinematicRing
{
    ...
    /*!
        *\brief Update joint positions of robots and grippers using robot_descriptioin.
         */
    static bool PublishJointStates(ros::NodeHandle & nh, std::string joint_state_topic);
    ////////////////////////////////////////////////
...
#endif
extern std::vector<boost::shared_ptr<CController> > ncs;
}
