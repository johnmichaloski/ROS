...
public:
    ...
    NearestJointsLookup(boost::shared_ptr<RCS::CController> cnc,
            IKinematicsSharedPtr kin) : _kinematics(kin), _cnc(cnc) {
    }
    ...
    virtual std::vector<double> FindClosest(tf::Pose pose) {
    ...
    virtual boost::shared_ptr<RCS::CController> RobotNC() {
        return _cnc;
    }
};
...
public:
    ...
    FanucNearestJointsLookup(boost::shared_ptr<RCS::CController>cnc, IKinematicsSharedPtr kin) :
    NearestJointsLookup(cnc, kin) {
    }
    virtual void SetRobotHints();
};
...
public:
    ...
    bool bAllHint;
    MotomanNearestJointsLookup(boost::shared_ptr<RCS::CController> cnc, IKinematicsSharedPtr kin) :
    NearestJointsLookup(cnc, kin) {
        bAllHint=false;
    }
    virtual void SetRobotHints();
    virtual std::vector<double> Hint(tf::Pose finalpose);
