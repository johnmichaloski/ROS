        ...
        do {
            ...
            if (incmds.SizeMsgQueue() > 0) {
               std::string msg = incmds.PopFrontMsgQueue();
                ...
                if (strcasecmp(tokens[0].c_str(), "quit") == 0) break;
                if (strcasecmp(tokens[0].c_str(), "degrees") == 0) bDegrees = true;
                if (strcasecmp(tokens[0].c_str(), "radians") == 0) bDegrees = false;
                if (strcasecmp(tokens[0].c_str(), "degree") == 0) bDegrees = true;
                if (strcasecmp(tokens[0].c_str(), "radian") == 0) bDegrees = false;
                ...
                if (strcasecmp(tokens[0].c_str(), "color") == 0) {
                    std::vector<std::string> dbls = Split(tokens[1], ',');
                ...
                if (strcasecmp(tokens[0].c_str(), "marker") == 0) {
 
                }
                if (strcasecmp(tokens[0].c_str(), "joints") == 0 ||
                ...
                if (strcasecmp(tokens[0].c_str(), "home") == 0) {
                    updater.Update(updater.JointNames(), std::vector<double> (updater.NumJoints(), 0.0));
                } 
                if (strcasecmp(tokens[0].c_str(), "rand") == 0){
